...
relatedTreks[]->{
    ...
    <div className="w-full lg:flex-1 space-y-2">
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <div className="flex-1 border p-4 bg-primary text-center">
          ...
          <p className="text-white font-medium">{data.facts.highAltitude}</p>
  ...
  {/* LETS TALK */}
  <section className="flex flex-col items-center justify-center px-[16px] lg:px-[32px] mb-[90px]">
    <div className="min-h-[60vh] md:h-[84vh] w-full">
      <LetsTalk
  ...
  {/* PARALLAX — hidden on mobile */}
  <section className="relative w-full h-[40vh] md:h-[80vh] hidden lg:block mb-[90px]">
    <div
...
<section className="flex flex-col lg:flex-row px-[16px] lg:px-[32px] gap-2 mb-[90px] items-stretch">
  ...
  <section className="flex flex-col px-[16px] lg:px-[32px] items-center justify-center gap-2 mb-[90px]">
    ...
    <p className="my-[24px] text-center w-full lg:px-[142px]">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 w-full">
      {data.relatedTreks?.map((item: any, index: number) => (
        <div key={index} className="w-full">
          <div className="w-full border h-[300px] sm:h-[350px] lg:h-[400px]">
            <Image
          ...
          <div className="p-[16px] lg:p-[24px] bg-primary text-center">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full mt-2">
      {data.relatedTreks2.slice(0, 2)?.map((item: any, index: number) => (
        <div key={index} className="w-full">
          <div className="w-full border h-[360px] sm:h-[460px] lg:h-[540px]">
            <Image
              src={item.hero.imageUrl}
              alt="img"
              height={400}
